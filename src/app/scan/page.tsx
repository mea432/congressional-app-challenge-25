              ...
              {(processMeetUpSuccess && processMeetUpSuccess[0] == true) && (
                <div className="bg-blue-600 bg-opacity-80 p-4 rounded text-white text-lg mt-4">
                  ...
                  {(!showStreak) ? (
                    ...
                    <>
                      {(processMeetUpSuccess[2] === 1) ? (
                        <p>Log another meetup in a day or the set interval to start a streak</p>
                      ) : (
                        <>
                          Streak: <br />
                          ...
                          {(processMeetUpSuccess[2] === 2) && (<p>Log another meetup within the set interval to grow your streak</p>)}
